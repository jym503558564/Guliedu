    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('gilr', '女'), ('boy', '男')], default='girl', max_length=10, verbose_name='用户性别')),
                ...
                ('iamge', models.ImageField(blank=True, max_length=200, null=True, upload_to='user/', verbose_name='用户头像')),
